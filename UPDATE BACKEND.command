...
echo 'STEP 1 of 4 - Sign in to Vercel'
...
echo
echo 'STEP 2 of 4 - Find your voom-backend project'
...
echo
echo 'STEP 3 of 4 - Admin phone number (the boss who approves drivers)'
...
echo
echo 'STEP 4 of 4 - Send the new backend online (1-2 minutes)'
